...
public class housePaint {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter length of house (horizontal): ");
		houseLength = in.nextDouble();
		
		System.out.print("Enter width of house(vertical not including peak): ");
		houseWidth = in.nextDouble();

		System.out.print("Enter height of house (base of house to peak): ");
		houseHeight = in.nextDouble();
		
		System.out.print("Enter the number of windows on the house: ");
		numberOfWindows = in.nextInt();
		
		System.out.print("Enter length of one window (horizontal): ");
		lengthOfWindows = in.nextDouble();
		
		System.out.print("Enter width of one window (vertical): ");
		widthOfWindows = in.nextDouble();
		
		System.out.print("Enter the number of doors on the house: ");
		numberOfDoors = in.nextInt();
		
		System.out.print("Enter length of one door on the house (horizontal): ");
		lengthOfDoors = in.nextDouble();
		
		System.out.print("Enter width of one door on the house (vertical): ");
